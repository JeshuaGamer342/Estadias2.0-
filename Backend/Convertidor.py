...
input_path  = os.path.join(base_dir, 'OjalaYaQuede.csv')    # archivo original
output_path = os.path.join(base_dir, 'OjalaYaQuede_normalized.csv')  # archivo resultante
...
def normalize_boolean(value):
    ...
    if v == '':
        return ''
    # por defecto devolver original trimmed (o podrías devolver '').
    return v
